...
# simpleTexture3D_kernel.o:simpleTexture3D_kernel.cu
# 	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

# $(APP): main.o simpleTexture3D_kernel.o
$(APP): main.o 
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -o $@ $+ $(LIBRARIES)
	$(EXEC) mkdir -p build/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)
	$(EXEC) cp $@ build/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)
...
clean:
	rm -f $(APP) main.o
	rm -rf build/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/$(APP)
