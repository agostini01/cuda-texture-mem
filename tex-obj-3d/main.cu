...
int main()
{
  ...
  // Copy from original surface and add 2
  copyKernel<<<dimGrid, dimBlock>>>(inputSurfObj,
                                    outputSurfObj,
                                    width, height);

  // Copy for the output surface and add another 2
  copyKernel<<<dimGrid, dimBlock>>>(outputSurfObj,
                                    outputSurfObj,
                                    width, height);
